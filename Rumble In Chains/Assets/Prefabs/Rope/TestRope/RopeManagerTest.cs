...
public class RopeManagerTest : MonoBehaviour
{
    ...
    public float ropeLoopIterations = 3;
    ...
    {
        Vector2 positionBeforeUpdate = leftPlayer.transform.position;
        leftPlayer.TranslatePosition((leftPlayer.position - leftPlayer.previousPosition) * 1.0f); // *0.9f pcq ??
        leftPlayer.TranslatePosition(Vector2.down * gravity * Time.deltaTime * Time.deltaTime);
        leftPlayer.previousPosition = positionBeforeUpdate;
    }
    ...
    private void ComputePosition()
    {
        ...
        leftPlayer.position = leftPlayer.transform.position;
        ...
        //leftPlayer.UpdateCollisions();//On le fait avant et après histoire d'être sûr qu'il soit pas dans un collider
        ...
        rightPlayer.UpdateCollisions(); //On le fait avant et après histoire d'être sûr qu'il soit pas dans un collider
    }
